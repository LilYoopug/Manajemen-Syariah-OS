    ...
    setMessages([
      {
        role: 'model',
        content:
          'Assalamualaikum! I am your AI Muamalah Assistant. How can I help you with your Syariah management questions today?',
      },
    ]);
  }, []);
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {promptSuggestions.map((prompt) => (
                  <button
                    ...
                    className="px-3 py-1 text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600"
                  >
                    {prompt}
                  </button>
                ))}
