      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
            Kelola hak akses anggota platform.
          </p>
        </div>
        ...
        <div className="p-4 sm:p-6 border-b dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/30 flex-shrink-0">
          <div className="relative">
            <input
              ...
              className="w-full px-5 py-3 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all text-sm shadow-sm"
            />
          </div>
        </div>
        <div className="flex-1 overflow-x-auto overflow-y-auto">
          <table className="w-full min-w-[600px]">
            <thead className="bg-gray-50 dark:bg-gray-900/50 border-b dark:border-gray-700 sticky top-0 z-10">
              <tr>
                <th className="px-4 sm:px-6 py-4 text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest text-left min-w-[180px]">
                  Identitas
                </th>
                <th className="px-4 sm:px-6 py-4 text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest text-left min-w-[200px]">
                  Email
                </th>
                <th className="px-4 sm:px-6 py-4 text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest text-left min-w-[80px]">
                  Role
                </th>
                <th className="px-4 sm:px-6 py-4 text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest text-right min-w-[100px]">
                  Aksi
                </th>
              </tr>
            </thead>
                ...
                <>
                  {paginatedUsers.map((user) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 sm:px-6 py-4">
                          <span
                            className={`inline-flex px-2 py-1 rounded-md text-[10px] uppercase font-bold tracking-wider whitespace-nowrap ${user.role === 'admin' ? 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300'}`}
                          >
                            {user.role}
                          </span>
                        </td>
                  ...
                  {paginatedUsers.length === 0 && (
                    <tr>
                      <td
                        colSpan={4}
                        className="px-4 sm:px-6 py-12 text-center text-gray-500 dark:text-gray-400 italic"
                      >
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 border border-transparent rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all shadow-sm pr-12"
