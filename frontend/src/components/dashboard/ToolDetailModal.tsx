        ...
        <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            ...
            <div className="space-y-4">
                <div>
                    ...
                    <input type="number" value={price} onChange={e => setPrice(Number(e.target.value))} className="mt-1 w-full px-3 py-2 text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-md focus:outline-none focus:ring-1 focus:ring-primary-500" placeholder="Contoh: 10000000" />
                </div>
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Margin Keuntungan (%)</label>
                    <input type="number" value={margin} onChange={e => setMargin(Number(e.target.value))} className="mt-1 w-full px-3 py-2 text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-md focus:outline-none focus:ring-1 focus:ring-primary-500" placeholder="Contoh: 15" />
                </div>
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Jangka Waktu (Bulan)</label>
                    <input type="number" value={tenor} onChange={e => setTenor(Number(e.target.value))} className="mt-1 w-full px-3 py-2 text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-md focus:outline-none focus:ring-1 focus:ring-primary-500" placeholder="Contoh: 12" />
                </div>
            </div>
      ...
      >
        ...
        >
          ...
          <div className="mt-6 space-y-4 text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Manfaat Utama:</h4>
              <ul className="text-sm space-y-1">
            ...
            {tool.relatedDalilText && (
              <div className="p-5 bg-primary-50 dark:bg-primary-900/20 border-l-4 border-primary-500 rounded-r-xl">
                ...
                <blockquote className="mt-2">
                  <p className="text-md italic text-gray-800 dark:text-gray-200">"{tool.relatedDalilText}"</p>
                  {tool.relatedDalilSource && (
                    <footer className="text-right text-sm text-gray-500 dark:text-gray-400 mt-2">— {tool.relatedDalilSource}</footer>
                  )}
                </blockquote>
              </div>
            )}
